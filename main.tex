  ...
  \begin{columns}[T]
    \begin{column}{.49\linewidth}
        ...
        \begin{columns}
          ...
          \begin{column}{0.6\columnwidth}
            ...
            \begin{itemize}
              ...
              \item Electrons accelerated into a linear tube
              \item Velocity modulation in buncher cavity by input signal
              \item Density modulated charge carrier wave forms through driftspace
              \item Outcoupling via catcher cavity
            \end{itemize}
          \end{column}
        \end{columns}
        \begin{columns}
          ...
          \begin{column}{0.6\columnwidth}
            ...
            \begin{itemize}
              \item Replace catcher cavity with 2 level quantum system
              \item Drive system using \textit{non-radiative electromagnetic near-field} of
                    electron beam.
              ...
              \end{itemize}
              \item Ability to draw arbitrary potentials (drive optical dipole, \\quadrupole, $\ldots$ transitions, spin systems, $\ldots$)
            \end{itemize}
          \end{column}
        \end{columns}
      \end{block}
      ...
      \begin{block}{\large Electron spin resonance with electron beams}
        ...
        classic electron spin resonance where systems are excited using microwaves
        ...
        \begin{columns}
          \begin{column}{0.6\columnwidth}
            \begin{itemize}
              \item Koelsch radical \- $\alpha,\gamma$-Bisdiphenylene-$\beta$-phenylallyl
              \item Unpaired spin $\to$ high spin density
              \item Excitation with microwave works at room temperature
              \item RF excitation background by radiated fields $\to$ differential measurements with and without electron beam required
            \end{itemize}
          \end{column}
          \begin{column}{0.4\columnwidth}
      ...
      \begin{block}{\large Temperature dependence}
        \begin{columns}
          \begin{column}{0.4\columnwidth}
            \includegraphics[width=\columnwidth]{figures/tempn2n1.png}
          \end{column}
          \begin{column}{0.6\columnwidth}
            \begin{itemize}
              \item Thermal population of spin states heavily temperature dependent
              \item $\frac{n_2}{n_1} = e^{-\frac{Delta E}{k_B T}} = \left(e^{- \frac{\Delta E}{k_B}}\right)^\frac{1}{T}$
              \item Moving to $77K$ (liquid nitrogen): \\ expect $8.9nV$ signal \\ expected gain $\approx 4$, SNR gain $\approx 7.7$ \\ simple to realize
              \item Moving to $4K$ (liquid helium): \\ expect $1.7\mu V$ signal \\ expected gain $\approx 75$, SNR gain $\approx 650$ \\ challenging to realize
            \end{itemize}
          \end{column}
        \end{columns}
      \end{block}
        ...
        \begin{columns}
          ...
          \begin{column}{0.4\columnwidth}
            \begin{itemize}
              ...
              \item Performing lock-in detection
            \end{itemize}
          \end{column}
        \end{columns}
      \end{block}
